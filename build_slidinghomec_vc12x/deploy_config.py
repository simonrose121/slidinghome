...
config = {}
cmdline = ['C:/Marmalade/7.3/s3e/makefile_builder/mkb.py', 'c:/Users/b2036561/Desktop/SlidingHome/SlidingHomeC.mkb', '--buildenv=VC12X', '--test-assets', 'Default', '--fake-vc-call', '--deploy-only']
